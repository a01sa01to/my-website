...
const opendata_basepath = path_1.default.join(
  __dirname,
  '..',
  '..',
  '..',
...
const getData = () => {
  const LastUpdate = JSON.parse(
    fs_1.default
      .readFileSync(
        path_1.default.resolve(opendata_basepath, 'last_update.json')
      )
      .toString()
  )
  const ret = {}
  {
    ...
    const json_data = JSON.parse(
      (0, csv2json_1.default)(filecontent, overrides_map)
    )
    ret.call_center = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.call_center),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.death_attributes = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.death_attr),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.death_number = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.death_number),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    json_data['last_update'] = (0, str2date_1.default)(
      LastUpdate.inspections_summary
    )
  ...
  }
  {
    ...
    ret.mutant_positive_number = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.mutant_positive),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.mutant_test_people = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.mutant_test_people),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.patients = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.patients),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.positive_number = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.positive_number),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.recovered_number = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.recovered_number),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.test_people = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.test_people),
        before,
        after,
        first,
        last
  ...
  }
  {
    ...
    ret.vaccination = ({ before, after, first, last }) =>
      (0, pagination_1.PaginationFn)(
        json_data,
        (0, str2date_1.default)(LastUpdate.lastUpdate),
        before,
        after,
        first,
        last
